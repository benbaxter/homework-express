...
<body>
	<div class="container-fluid">
		<div class="hero-unit">
			...
			<form method="post" name="submitAssignmentForm" enctype="multipart/form-data" 
				action="${submitUrl}"
				...
				<input type="hidden" name="containsMain" id="containsMain" />
				
				<div id="fileInputs">
				</div>
				
				<br />
				<a class="btn" href="<c:url value="/actions/student/course/${courseid}/assignment/${assignment.id}" />">Cancel</a>
				<a class="btn btn-inverse" href="javascript: addAnotherFile()">Add Another File</a>
